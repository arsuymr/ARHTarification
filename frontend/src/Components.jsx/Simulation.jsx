...
export default function SimulationPage() {
    ...
    const fetchData = async () => {
        try {
            ...
            if (selectedOperator) {
                ...
                const response = await axios.get('http://127.0.0.1:5000/resultat/Simulation', {
                    params: {
    ...
    const handleParamSubmit = () => {
        ...
        Object.keys(resultData).forEach(nomUnity => {
            axios.post('http://127.0.0.1:5000/resultat/ValiderSimulation', {
                            ...
                            <FormControl fullWidth >
                                ...
                                >
                                    {operatorList.map((operator) => (
                                        <MenuItem key={operator.OperateurID} value={operator.OperateurID}>
